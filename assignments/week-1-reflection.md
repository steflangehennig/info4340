...
This assignment is low-stakes and formative. It's designed to get you thinking in the course's framework (understand, use, evaluate, govern) and to surface your interests so we can connect course material to your work.
...
| Risk assessment | Applies 2+ risk dimensions with clear justification | Assigns a risk level but justification is thin | No risk assessment or unsupported rating |
