...
3. **Governance rules with thresholds** - top 3 risk domains, each with measurable triggers referencing course metrics (confidence thresholds, F1 minimums, disparity ratios, cost caps)
...
| Quantitative thresholds | 3+ rules with specific, measurable triggers | Some rules but thresholds vague | Principles only |
