...
subtitle: "What it is, why it matters, and how to write a good one"
...
Every weekly deliverable in this course (starting Week 3) requires one.
...
2. **Learning.** Writing a log forces you to notice when you're relying on AI versus exercising your own judgment. Over 10 weeks, your logs will show you how your relationship with AI tools evolves — where you trust them more, where you trust them less, and where you've learned to verify.
...
You don't need to log every single interaction. Focus on the interactions that shaped your work — the ones where AI generated something you built on, or where you caught an error, or where AI's suggestion changed your approach.
...
**Also a bad log:** Logging every trivial interaction ("I asked Copilot to autocomplete a print statement"). Focus on interactions that mattered.

## Common questions

**Do I need to log every autocomplete suggestion from Copilot?**
...
That's fine — note it. "I wrote the interpretation section without AI assistance because I wanted to make sure the contextual framing reflected my understanding of the data." That's valuable information.
